...
const AdminProductCard: React.FC<AdminProductCard> = ({ data }) => {
  return (
    <div className=" w-full group flex flex-col h-fit relative">
      ...
      <div className=" cursor-pointer group-hover:opacity-100 opacity-0 ease-in-out transition-opacity duration-100 h-14 aspect-square rounded-full absolute right-20 top-4 bg-black/50 backdrop-blur-md z-10 inline-flex items-center justify-center">
        <Trash2 />
      </div>
