const PrimaryButton = (props: React.PropsWithChildren) => {
  return (
    <button className="relative w-full h-10 hover:scale-105 ease-in-out transition-all duration-200 px-3 rounded-lg font-medium text-white text-sm bg-gradient-to-b from-[#0245A6] to-[#0096FA] shadow-[0px_0px_12px_#0096FA]">
