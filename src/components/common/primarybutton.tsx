const PrimaryButton = (props: React.PropsWithChildren) => {
  return (
    <button className="relative  w-full h-10 inline-flex items-center justify-center px-3 md:px-4 rounded-lg font-medium text-white text-sm md:text-base bg-gradient-to-b from-[#0245A6] to-[#0096FA] shadow-[0px_0px_12px_#0096FA]">
