...
const ProductPreview = () => {
  return (
    <Dialog>
      ...
      <DialogContent className="flex flex-col overflow-y-scroll max-w-full h-[86dvh] md:h-[96vh] p-0 w-[92vw] md:w-[90vw] border-none rounded-xl md:rounded-2xl overflow-clip">
