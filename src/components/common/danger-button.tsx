const DangerButton = (props: React.PropsWithChildren) => {
  return (
    <button className="relative  w-full h-10 inline-flex items-center justify-center hover:scale-105 ease-in-out transition-all duration-200 px-3 md:px-4 rounded-lg font-medium text-white text-sm md:text-base bg-gradient-to-b from-[#A60202] to-[#FA4E4E] shadow-[0px_0px_12px_#FA4E4E]">
